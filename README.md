...
<body>
    ...
    <script>
        function calculateSavings() {
            ...
            document.getElementById("living-expense").textContent = livingExpense + " Ngàn VNĐ";
            document.getElementById("food-expense").textContent = foodExpense + " Ngàn VNĐ";
            document.getElementById("transportation-expense").textContent = transportationExpense + " Ngàn VNĐ";
            document.getElementById("savings-expense").textContent = savingsExpense + " Ngàn VNĐ";

            var totalSavings1Month = savingsExpense * 30;
            var totalSavings2Months = savingsExpense * 60;

            document.getElementById("savings-1-month").textContent = totalSavings1Month + " Ngàn VNĐ";
            document.getElementById("savings-2-months").textContent = totalSavings2Months + " Ngàn VNĐ";
        }
    </script>
</body>
</html>
